...
class NodeCluster:
    ...
    def __init__(self, node, dataset=None, adj_list=None, gen_hierarchies=None):
        ...
        self._genCatFeatures = {
            'birth_country_mother': self._dataset[node]['birth_country_mother'],
            'marital_stat': self._dataset[node]['marital_stat']
        }
    ...
    def toString(self):
        ...
        for count in range(0, len(self._nodes)):
            ...
            out_string += self._genCatFeatures['birth_country_mother'] + ", "
            out_string += self._genCatFeatures['marital_stat'] + "\n"
